  ...
  return (
    <MainLayout>
      ...
      <div className="mb-4 max-w-9xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="text-[1.13rem] sm:text-3xl font-extrabold bg-gradient-to-r from-teal-400 via-cyan-400 to-blue-400 bg-clip-text text-transparent drop-shadow-md">
          Health Dashboard
        </h1>
        <img src="flag.gif" 
          className="mx-2 w-18 h-5 sm:h-7 inline-block rounded-sm" alt=""/>
        </div>
        <p className="mt-1 flex flex-row text-pink-400 text-sm sm:text-base hover:text-pink-900">
          Track and monitor your vital health metrics
          <Activity className="text-blue-400 mt-[0.3rem] w-5 h-5 mx-1" />
        </p>
      </div>
