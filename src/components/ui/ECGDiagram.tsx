...
const ECGDiagram: React.FC<ECGDiagramProps> = ({ ecgData }) => {
  ...
  return (
    <div className="flex items-center justify-center  min-h-[20vh] sm:min-h-[50vh] bg-[#212121] p-3 md:p-6">
      <div className="rounded-2xl bg-white p-3 sm:p-6 shadow-lg w-[850px]">
        <h2 className="text-base md:text-2xl font-semibold text-gray-700 mb-4 text-center">
          ECG Diagram
        </h2>
        ...
        <div className="mt-4 text-center">
          <button
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white text-[8px] sm:text-base font-semibold py-2 px-4 rounded-md transition"
          >
            Download ECG Image
          </button>
        </div>
